                ...
                @foreach($posts as $post)
                    <tr>
                        ...
                        @can('publish post')
                            ...
                            <td>
                                <form action="{{ route('publish.store') }}" method="POST" class="mb-3">
                                    @csrf
                                    <input type="number" class="form-control" id="floatingInput" name="post_id" hidden value="{{ $post->id }}">
                                    <input type="number" class="form-control" id="floatingInput" name="user_name" hidden value="{{ $post->user->name }}">
                                    ...
                                    <input type="number" class="form-control" id="floatingInput" name="price" hidden value="{{ $post->price }}">we
